...
public class BuyerAdapter extends RecyclerView.Adapter<BuyerAdapter.Holder> {
    ...
    public BuyerAdapter(Context context, ArrayList<Model> arrayList) {
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.buyer_row,parent,false);
